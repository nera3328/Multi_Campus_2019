...
print('첫번째 이야기 단어: ',story1_words)
story2_words=story2.split(" ")
print('두번째 이야기 단어: ',story2_words)

story1_vocab=set(story1_words)
print('중복이 제거된 어휘: ',story1_vocab)

story2_vocab=set(story2_words)
print('중복이 제거된 어휘: ',story2_vocab)

commonvoca=story1_vocab & story2_vocab
print('공통 어휘 : ',commonvoca)